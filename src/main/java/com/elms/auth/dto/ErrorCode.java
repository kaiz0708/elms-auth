...
public class ErrorCode {
     ...
     * */
    public static final String STORE_ERROR_UNKNOWN = "ERROR-STORE-0000";
    public static final String STORE_ERROR_NOT_FOUND= "ERROR-STORE-0001";
    public static final String STORE_ERROR_DUPLICATE_PATH= "ERROR-STORE-0002";

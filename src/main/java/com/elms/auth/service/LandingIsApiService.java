...
public class LandingIsApiService {
    @Autowired
    LandingIsOTPService landingIsOTPService;
    ...
    public String getOTPForgetPassword(){
        return landingIsOTPService.generate(4);
    }

    public synchronized Long getOrderHash(){
        return Long.parseLong(landingIsOTPService.generate(9))+System.currentTimeMillis();
    }
    ...
    public String getOrderStt(Long storeId){
        return landingIsOTPService.orderStt(storeId);
    }

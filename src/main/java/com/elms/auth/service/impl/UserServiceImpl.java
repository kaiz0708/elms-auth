package com.elms.auth.service.impl;
...
import com.elms.auth.config.SecurityConstant;
...
public class UserServiceImpl implements UserDetailsService {
    ...
    public Account getCurrentUser() {
        try {
            ...
            if (authentication != null) {
                return accountRepository.findAccountByUsername(SecurityContextHolder.getContext().getAuthentication().getName());
            } else {
                return null;
            }
        } catch (Exception e) {
    ...
    public LandingIsJwt getAddInfoFromToken() {
        Authentication authentication = SecurityContextHolder.getContext().getAuthentication();
        Long userId = null;
        if (!(authentication instanceof AnonymousAuthenticationToken)) {
            ...
            if (oauthDetails != null) {
                ...
                if (encodedData != null && !encodedData.isEmpty()) {
                    return LandingIsJwt.decode(encodedData);
                }
                return null;
            }
        }
    ...
    public OAuth2AccessToken getAccessTokenForAnonymous(ClientDetails client, TokenRequest tokenRequest, String username, String tenant, AuthorizationServerTokenServices tokenServices) throws GeneralSecurityException, IOException {
        Map<String, String> requestParameters = new HashMap<>();
        requestParameters.put("grantType", SecurityConstant.GRANT_TYPE_ANONYMOUS);
